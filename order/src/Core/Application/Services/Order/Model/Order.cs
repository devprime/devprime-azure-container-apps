...
public class Order
{
    ...
    public IList<Application.Services.Order.Model.Item> Itens { get; set; }
    ...
    public static Application.Services.Order.Model.Order ToApplication(Domain.Aggregates.Order.Order order)
    {
        ...
        _order.Itens = Application.Services.Order.Model.Item.ToApplication(order.Itens);
    ...
    public static Domain.Aggregates.Order.Order ToDomain(Application.Services.Order.Model.Order order)
    {
        ...
        Domain.Aggregates.Order.Order _order = new Domain.Aggregates.Order.Order(order.ID, order.CustomerName, order.CustomerTaxID, Application.Services.Order.Model.Item.ToDomain(order.Itens), order.Total);
        return _order;
    }
